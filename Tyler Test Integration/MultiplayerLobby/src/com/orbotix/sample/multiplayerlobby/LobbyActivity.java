    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMultiplayerClient.setOnGetPlayersListener(new LocalMultiplayerClient.OnGetPlayersListener() {
            ...
            public void onGetPlayers(Context context, List<RemotePlayer> players) {
                ...
                //for(int a = 0; a<4; a++){
                	//i.putExtra(HelloWorld.players[a], players.get(a).getName());
                //}
            }
        });
...
//        updatePlayerList(players);
//        
//        Map<String, ArrayList<Float>> players_map = new HashMap<String, ArrayList<Float>>();
//        
//        for(int a = 0; a < 4; a++) {
//        	ArrayList<Float> vals = new ArrayList<Float>();
//        	for(int j = 0; j < 3; j++)
//        		vals.add(0.0f);
//        	players_map.put(players.get(a).getName(), vals);
//        }
//        if(mMultiplayerClient.getIsHost()) {
//	    	HelloWorld.player_values = players_map;
