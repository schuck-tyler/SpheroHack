...
public class CalibrationActivity extends Activity implements CalibrationDialView.CalibrationEventListener {
	...
	public static String ROBOT_ID_EXTRA;
	...
	protected void onStart() {
		...
		Log.d("CalibrationActivity", "onStart was run");
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if(requestCode == STARTUP_ACTIVITY && resultCode == RESULT_OK){
			ROBOT_ID_EXTRA = data.getStringExtra(StartupActivity.EXTRA_ROBOT_ID);
			if (ROBOT_ID_EXTRA != null) {
				RobotProvider provider = RobotProvider.getDefaultProvider();
				robotControl = provider.getRobotControl(provider.findRobot(ROBOT_ID_EXTRA));
			}
		}
	}
